...
namespace MassTransit
{
    ...
    public static class RavenSubscriptionRouterExtensions
    {
        /// <summary>
        /// Specify subscription storage for the bus instance using RavenDB
        /// </summary>
        /// <param name="documentStore">The document store for the storage</param>
